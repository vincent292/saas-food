...
export default async function OrdersPage({
  ...
  return <OrdersReceptionClient categories={categories} configuration={configuration} hasOpenSession={Boolean(cashSummary.session)} orders={orders} printConnectorLink={printConnectorLink} products={products} restaurant={restaurant} settings={settings} showFloatingPos={canUsePos} status={status} />;
}
