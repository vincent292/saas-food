...
export type Database = {
  public: {
    Tables: {
      ...
      platform_rider_payment_settings: Row<{
        id: boolean;
        amount: number;
        currency: string;
        qr_url: string | null;
      ...
      whatsapp_conversations: Row<{
        ...
        from_phone: string;
        restaurant_id: string | null;
        state: "idle" | "choosing_restaurant" | "browsing_menu" | "drafting_order" | "handoff";
      ...
      whatsapp_order_drafts: Row<{
        id: string;
        conversation_id: string;
        customer_id: string;
        restaurant_id: string | null;
        status: "open" | "ready_to_confirm" | "converted" | "abandoned";
        items: Json;
